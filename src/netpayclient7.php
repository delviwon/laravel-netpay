...
function buildKey($key)
{
    ...
    $enc = mcrypt_decrypt ($cipher,DES_KEY,$prime1,MCRYPT_MODE_CBC,$iv);
    $private_key["prime1"] = $enc;
    $prime2 = substr($bin,448,64);
    $enc = mcrypt_decrypt ($cipher,DES_KEY,$prime2,MCRYPT_MODE_CBC,$iv);
    $private_key["prime2"] = $enc;
    $prime_exponent1 = substr($bin,512,64);
    $enc = mcrypt_decrypt ($cipher,DES_KEY,$prime_exponent1,MCRYPT_MODE_CBC,$iv);
    $private_key["prime_exponent1"] = $enc;
    $prime_exponent2 = substr($bin,576,64);
    $enc = mcrypt_decrypt ($cipher,DES_KEY,$prime_exponent2,MCRYPT_MODE_CBC,$iv);
    $private_key["prime_exponent2"] = $enc;
    $coefficient = substr($bin,640,64);
    $enc = mcrypt_decrypt ($cipher,DES_KEY,$coefficient,MCRYPT_MODE_CBC,$iv);
